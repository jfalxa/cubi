import { ArcRotateCamera, Vector3, type Observer, type Scene } from '@babylonjs/core';

import type { Context, Intent, Interactions, Interactive } from './interactions';
import { createIntent, hasCtrl, hasShift } from './interactions';
...
export class Camera extends ArcRotateCamera implements Interactive {
	...
	constructor(view: View, interactions: Interactions) {
		...
		this.zoomObserver = this.view.scene.onBeforeRenderObservable.add(this.adaptPanningSensibility);
